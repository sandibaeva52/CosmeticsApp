...
public class Products {
    ...
    public Products(String id, String brand, String name, String price, String priceSign, String currency, String imageLink, String productLink, String websiteLink, String description, Object rating, String category, String productType, String createdAt, String productApiUrl, String apiFeaturedImage) {
        super();
        this.id = id;
        this.brand = brand;
        this.name = name;
